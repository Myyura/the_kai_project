-- ============================================================
-- Kai Project Supabase 基线结构
-- 新环境先在 Supabase SQL Editor 中执行本脚本，再按顺序应用
-- supabase/migrations/。已有环境只需应用尚未执行的有序迁移。
-- ============================================================
--
...
-- 排行榜 UUID 查询与仅登录实名参与规则由有序迁移
-- supabase/migrations/20260718000200_authenticated_profiles_and_uuid_queries.sql 创建。
