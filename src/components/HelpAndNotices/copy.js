const HELP_AND_NOTICES_COPY = {
  zh: {
    ...
    contributorLinkTitle: '感谢所有贡献者',
    contributorLinkText: '完整的代码、文档、题解与纠错贡献名单现已收录在「支持与合作」页面。',
    legalTitle: '法律与隐私声明',
    legalSections: [
      {
        id: 'copyright',
        title: '版权声明',
        items: [
          '本网站以开源项目和公开资料库为基础，核心公开内容包括题库索引、社区贡献题解、公开备考资料及相关说明。上述内容将持续面向公众免费开放访问，用于支持个人学习、研究与备考参考。',
  ...
  ja: {
    ...
    contributorLinkTitle: 'すべての貢献者に感謝します',
    contributorLinkText: 'コード、文書、解答、訂正の完全な一覧は「支援・パートナーシップ」ページへ移動しました。',
    ...
    legalSections: [
      {
        ...
        title: '著作権に関する方針',
        items: [
          '本サイトはオープンソースプロジェクトおよび公開資料アーカイブとして運営されています。主要な公開コンテンツには、問題集の索引、コミュニティが投稿した解答、公開されている受験資料、関連する説明が含まれ、個人の学習、研究、受験準備を支援する目的で今後も無償で公開されます。',
  ...
  en: {
    ...
    contributorLinkTitle: 'With thanks to every contributor',
    contributorLinkText: 'The complete code, documentation, solution, and correction record now lives on Support & Partnerships.',
    ...
    legalSections: [
      {
        ...
        title: 'Copyright',
        items: [
          'This website is built as an open-source project and public archive. Its core public content includes exam indexes, community-contributed solutions, publicly available study materials, and related documentation. This content remains freely accessible to support personal study, research, and exam preparation.',
