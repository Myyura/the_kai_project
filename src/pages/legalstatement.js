...
const content = {
  zh: {
    ...
    contributionSteps: [
      '轻度用户优先使用站内投稿表单，不需要理解 Git、frontmatter、目录结构或 CI。',
  ...
  ja: {
    ...
    guideTitle: '使い方',
    guides: [
      { icon: FaBookOpen, title: '過去問と解答を見る', text: '「过去问」から大学・研究科・年度ごとに問題と解答を閲覧できます。' },
      ...
      { icon: FaEdit, title: '投稿と訂正', text: 'マイページの投稿機能から新規解答や訂正を送信できます。', link: { to: '/me?tab=contribute', label: '投稿へ' } },
    ...
    contributionSteps: [
      '軽い投稿者はサイト内フォームから投稿でき、Git や文書形式を理解する必要はありません。',
  ...
  en: {
    ...
    contributionSteps: [
      'Light contributors submit through the website without knowing Git, frontmatter, or CI.',
