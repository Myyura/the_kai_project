...
const content = {
  zh: {
    ...
    links: [
      ...
      { name: 'hari64boli64, 東京大学大学院情報理工学系研究科入試問題過去問解答など', url: 'https://github.com/hari64boli64/GraduateSchoolEntranceExamination', tags: [] },
      { name: 'diohabara, open_inshi', url: 'https://github.com/diohabara/open_inshi', desc: '大学院入試過去問(2023年実施試験まで)', tags: [] },
      { name: '之遥, 东京大学·新领域创成研究科·复杂理工专攻2018-2023年度过去问解答', url: 'https://www.zhihu.com/people/zhao-yue-70-84', tags: [] },
      { name: 'etsurin, 东京大学情理数学解答例', url: 'https://zhuanlan.zhihu.com/p/561992447', tags: [] },
      ...
      { name: 'kainoj, UTokyo CS', url: 'https://github.com/kainoj/utokyo-cs', tags: [] },
      { name: 'tomfluff, UTokyo CI', url: 'https://github.com/tomfluff/UTokyo_CI_Entrance_Exam', tags: [] },
      { name: 'YuanzhongLi, UTokyo CI Programming', url: 'https://qiita.com/YuanzhongLi', tags: [] },
      { name: '江澤 樹, 名古屋大学大学院多元数理科学研究科博士前期課程の入学試験問題の解答・解説', url: 'https://sites.google.com/view/tatsukiezawa/%E8%A7%A3%E7%AD%94%E9%9B%86', tags: [] },
      { name: '藍色日和, 東大数理院試過去問解答例まとめ', url: 'https://mathlog.info/articles/zLhBwPhItOrD5zEO3psa', tags: [] },
      ...
      { name: '東大院、京大院、東工大院、東北大院機械系過去問の解答, SN', url: 'https://bloodystream.hatenadiary.jp/entry/2021/05/01/080000', tags: [] },
    ],
  ...
  ja: {
    ...
    links: [
      ...
      { name: 'hari64boli64, 東京大学大学院情報理工学系研究科入試問題過去問解答など', url: 'https://github.com/hari64boli64/GraduateSchoolEntranceExamination', tags: [] },
      { name: 'diohabara, open_inshi', url: 'https://github.com/diohabara/open_inshi', desc: '大学院入試過去問(2023年実施試験まで)', tags: [] },
      { name: '之遥, 東京大学新領域創成科学研究科複雑理工学専攻2018-2023年度過去問解答', url: 'https://www.zhihu.com/people/zhao-yue-70-84', tags: [] },
      { name: 'etsurin, 東京大学情報理工数学解答例', url: 'https://zhuanlan.zhihu.com/p/561992447', tags: [] },
