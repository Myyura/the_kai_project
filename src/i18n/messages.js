...
export const UI_MESSAGES = {
  ...
  home: {
    ...
    en: {
      ...
      progressBannerTitle: 'Local Study Progress',
      progressBannerDesc: 'Mark each problem as completed or for review. Your study progress is saved in the browser and can be checked anytime.',
      progressBannerCta: 'View study progress',
      progressBannerCompleted: 'Completed',
      progressBannerReviewing: 'Reviewing',
      progressBannerNoData: 'Mark a problem at the bottom of any exam page to begin',
      ...
      ctaButtonProgress: 'My Study Progress',
      ctaButtonGithub: 'GitHub',
    },
  },
  ...
  progress: {
    ...
    en: {
      ...
      pageSubtitle: 'All problem progress you mark is stored in your browser. Use cloud sync below to keep it across devices.',
      completed: 'Completed',
      reviewing: 'Reviewing',
  ...
  login: {
    ...
    en: {
      ...
      title: 'Cloud Sync',
      subtitle: 'Log in to sync your study progress and notes across devices',
      tabLogin: 'Log in',
  ...
  progressTracker: {
    ...
    en: {
      ...
      hint: 'View all study progress on the Study Progress page',
      nextReview: 'Next review',
      nextReviewToday: 'Today',
      nextReviewIn: (d) => `in ${d} days`,
      nextReviewOverdue: (d) => `${d} days overdue`,
  ...
  cloudSync: {
    ...
    en: {
      ...
      loggedIn: 'Logged in',
      logout: 'Log out',
      syncMerge: 'Two-way merge',
      syncMergeDesc: 'Merge by timestamp (recommended)',
      push: 'Push to cloud',
      pushDesc: 'Local overwrites cloud',
      pull: 'Pull from cloud',
      pullDesc: 'Cloud overwrites local',
