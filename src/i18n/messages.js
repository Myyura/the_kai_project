  ...
  home: {
    zh: {
      ...
      highlights: [
        ...
        {title: '社区驱动', subtitle: '共建共享', description: '加入QQ群 925154731，与考生和前辈交流备考经验'},
      ],
    ...
    ja: {
      ...
      highlights: [
        ...
        {title: 'コミュニティ主導', subtitle: '共に作る', description: 'GitHub Discussionsで受験生同士の情報交換ができます'},
      ],
    ...
    en: {
      ...
      highlights: [
        ...
        {title: 'Community Driven', subtitle: 'Built together', description: 'Join the community to share notes, solutions, and preparation experience.'},
      ],
