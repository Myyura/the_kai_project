export const developerMessages = {
  ...
  en: {
    ...
    subtitle: 'Manage features for third-party tools and automated workflows.',
    apiTitle: 'JSON API',
    apiSubtitle: 'Create API keys and use The Kai Project problem and solution data as JSON.',
    apiFeatureDesc: 'Structured access to the exam catalog, solution content, and source metadata.',
    apiFeatureCta: 'Manage API Keys',
    available: 'Available',
