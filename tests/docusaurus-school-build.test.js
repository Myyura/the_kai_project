...
const {
  ...
  runSchoolBuild,
} = require('../scripts/docusaurus-school-build');
const {
...
} = require('../scripts/docusaurus-school-shards');
const {
  assertCollectedDataMatchesRoutes,
  runSchoolShardSsg,
  writeSerializedShardData,
} = require('../scripts/docusaurus-ssg-school-shard');
const {
  finalizeSchoolShards,
  mergeShardPayloads,
} = require('../scripts/docusaurus-finalize-school-shards');
