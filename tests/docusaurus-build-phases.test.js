...
const {getBuildEnvironment} = require('../scripts/build-with-memory-limit');
const {getPagesBuildEnvironment} = require('../scripts/build-for-pages');
const {
  BUILD_LOCALE,
...
} = require('../scripts/docusaurus-build-phases');
const {
...
} = require('../scripts/docusaurus-bundle-target');
const {getCommandInvocation} = require('../scripts/run-docusaurus');
