...
## **Kai**
### (1)
まず前半については、$X$ の多項式と見れば $Y^5$ は $\mathbb C[Y]$ の平方でないので [$X^2-Y^5$ は既約多項式である](https://math.stackexchange.com/questions/652392/xn-ym-is-irreducible-in-bbbcx-y-iff-gcdn-m-1)。よって $R$ は整域である。
