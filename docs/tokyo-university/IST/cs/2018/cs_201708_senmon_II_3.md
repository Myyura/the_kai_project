...
## **Author**
[kainoj](https://github.com/kainoj/utokyo-cs), [Zephyr](https://inshi-notes.zephyr-zdz.space/Solutions/IS_CS/2018S/IS_CS-2018S2-03), 祭音Myyura
...
### (4)
Put $M_n=N_n+1$. Then $M_0=2\leq r^2$, $M_1=3\leq r^3$, and

$$
M_n=M_{n-1}+M_{n-2}\leq r^{n+1}+r^n=r^{n+2}.
$$

Thus $N_n<M_n\leq r^{n+2}$.
...
$$
C_n=O\left(\sum_{j=0}^n (j+1)r^{n-j}\right)
=O(r^n),
$$

because $\sum_{j\geq0}(j+1)/r^j$ converges.
