...
(5)、3次元実ベクトル$a$が与えられたとき、3次元実ベクトル$x$に関する関数$f$を

$$
f(x)=\sum_{k=1}^{n}\left \Vert\exp(\frac{2\pi k}{n}B)a-x \right \Vert ^2
$$

とおく．ただし、$n\ge2$とする．このとき、$x=(I+B^2)a$において$f$が最小になることを示せ．
