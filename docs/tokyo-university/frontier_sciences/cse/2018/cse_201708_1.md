...
3. 在 $(x,y)=(1,-1)$ 附近把 $f$ 展开到二次项，写出二元 Taylor 展开式。
4. 证明 $f$ 在 $(x,y)=(0.5,0.5)$ 处取得局部极大值。
5. 在约束

   $$
   x^2+y^2=1,\qquad x\ge0,\ y\ge0
   $$

   下求 $f$ 的极值，包括弧段内部及边界端点。
...
&f(x,y) \approx 0 + \frac{e^{-2}}{1!}(x - 1) + \frac{-4e^{-2}}{2!}(x-1)^2 + \frac{e^{-2}}{1!}(y + 1) + \frac{4e^{-2}}{2!}(y + 1)^2 + \frac{0}{1! \cdot 1!}(x - 1)(y + 1) \\
...
-3e^{-0.5} & -e^{-0.5} \\
-e^{-0.5} & -3e^{-0.5} \\
\end{vmatrix} = 8e^{-1} > 0 ,\frac{\partial ^2f}{\partial x^2}\bigg|_{(0.5,0.5)} = -3e^{-0.5} < 0 \\
