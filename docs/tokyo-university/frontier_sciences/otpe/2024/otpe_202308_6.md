...
tags:
  - Tokyo-University
  - Engineering.Fluid-Mechanics.Logarithmic-Wind-Profile-and-Wind-Power-Scaling
---
...
海上风速 $V$ 只依赖高度 $Z$，且其导数与 $1/Z$ 成正比：

$$
\frac{dV}{dZ}\propto\frac1Z,\qquad Z\ge0.125.
$$

已知

$$
V(0.125)=0,\qquad V(8)=6.
$$

回答：

1. 求高度 $Z=128$ 处的风速。
2. 通过高度 $Z$ 的海风功率 $P$ 与该高度风速的三次方成正比。求
   $$
   \frac{P(128)}{P(32)},
   $$
   即 $Z=128$ 处功率是 $Z=32$ 处的多少倍。

#### 考点

- **对数风速剖面**：积分 $dV/dZ=C/Z$ 得到关于高度的对数函数，并用两个边界风速确定常数。
- **风功率立方标度**：先比较两高度的风速，再把风速比取三次方得到功率比。
