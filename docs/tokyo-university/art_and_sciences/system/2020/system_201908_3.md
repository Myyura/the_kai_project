...
- **两体中心力约化**：在质心系中把两个质点的位置、动能和势能改写为约化质量的相对运动。
- **循环坐标与守恒动量**：由拉格朗日量不显含方位角推出角动量型守恒量。
- **有效势能**：把角向运动并入离心势，推导径向方程、总能量及圆轨道能量极小条件。
- **引力束缚轨道**：依据总能量符号判断束缚，并把相对轨道换算为各质点绕质心的轨道。
