...
本稿は主に2020〜2023年度の出題と著者の受験経験をまとめたもので、科目の選び方や教材への評価は著者の意見である。出願年度の試験方式は[専攻公式の入試案内](https://www.eeis.t.u-tokyo.ac.jp/education/guidebook/)、専門科目の範囲は[公式の出題科目・キーワード](https://www.eeis.t.u-tokyo.ac.jp/education/subject/)を確認すること。特別口述試験などの方式は以下の一般的な筆記試験対策と区別される。
...
ただ、電磁波も試験範囲に入ります。併願先での出題範囲も専攻・年度によって異なるため、それぞれの公式案内を確認してください。
...
プログラミングで疑似コードを記載する問題が出題されるものの、論理回路とアルゴリズム・プログラミングの基礎を押さえることが出発点になります。ただし、公式キーワードも出題内容を限定するものではなく、2講義だけで全範囲を保証できるわけではありません。
...
制御工学には伝達関数法に加え、状態空間法の基礎も含まれます。電気エネルギー工学は、電気機器と電力系統工学、高電圧工学の3分野が試験範囲です。
