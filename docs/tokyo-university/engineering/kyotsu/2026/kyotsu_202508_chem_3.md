...
まず 2-メチルシクロヘキサン-1,3-ジオンの活性メチンから生じたエノラートが、エチルビニルケトンの $\beta$ 炭素へ Michael 付加する。続く分子内アルドール付加と脱水により、Robinson 環化生成物 D を得る。
...
2-テトラロンとピロリジンの脱水縮合で、ベンゼン環と共役する C1=C2 結合をもつエナミン E が生じる。

```smiles
N1(CCCC1)C2=Cc3ccccc3CC2
```

E の求核的なエナミン炭素が $\ce{CH3I}$ に $S_\mathrm{N}2$ 攻撃し、酸加水分解でカルボニル基が再生する。これは Stork エナミンアルキル化であり、F は 1-メチル-2-テトラロンである。
...
4. 塩基が C2 上の H を引き抜き、C2–H 結合の電子対が C1=C2 結合をつくって芳香族性が回復する。

![NIH shift の電子対移動](https://raw.githubusercontent.com/Myyura/the_kai_project_assets/main/kakomonn/tokyo_university/engineering/kyotsu/2026/tokyo-kyotsu-202508-nih-shift.svg)
