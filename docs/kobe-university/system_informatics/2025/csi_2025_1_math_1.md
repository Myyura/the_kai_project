...
1. 设 $f(x)$ 是定义在 $[0,1]$ 上的非负连续函数。证明对任意 $b>0$，存在 $a\in[0,1]$ 满足
...
2. 考虑次数不超过 2 的一元实多项式组成的向量空间
   ...
   $$
   V=\{a_0+a_1x+a_2x^2\mid a_0,a_1,a_2\in\mathbb R\}.
   $$
