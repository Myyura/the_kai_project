---
sidebar_label: "2016年7月実施 情報数理応用 問題2"
tags:
  - Waseda-University
...
围绕应用于多维特征空间数据的模式识别与机器学习，回答下列问题：

1. 概述无监督学习与监督学习。
2. 说明 K 均值（k-means）方法的问题设定及算法过程。
3. 说明决策树分析所使用的模型与方法。
4. 说明支持向量机的分析方法。
5. 列举集体学习或集成学习的代表性方法，并概述其原理。

#### 考点

- K 均值聚类：需要说明如何把多维数据划分为若干簇，以及算法所优化的目标和迭代过程。
- 决策树：需要结合分类或预测任务说明树模型如何递归划分特征空间并形成输出。
- 支持向量机：需要说明如何利用分离超平面与间隔完成分类，并体现其分析方法的核心思想。
- 集成学习：需要列举代表性集成方法，并说明多个学习器如何组合以改善预测效果。
