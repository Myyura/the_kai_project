---
sidebar_label: "2016年7月実施 数理基礎 C"
tags:
  - Waseda-University
...
# 早稲田大学 創造理工学研究科 経営システム工学専攻 2016年7月実施 数理基礎 C
...
2. 求矩阵
   ...
   $$
   的全部特征值及对应特征向量。
3. 设 $E$ 为单位矩阵。对于满足 $E+A$ 可逆的矩阵 $A$，定义
   $$
   B=(E-A)(E+A)^{-1}.
   $$
   证明 $E+B$ 可逆，并证明
...
- 矩阵的秩：需要根据参数 $x$ 的取值考察子式或进行行变换，分情况确定给定 $3\times4$ 矩阵的秩。
- 特征值与特征向量：需要利用给定上三角矩阵的结构求出全部特征值，并分别解出各特征空间。
