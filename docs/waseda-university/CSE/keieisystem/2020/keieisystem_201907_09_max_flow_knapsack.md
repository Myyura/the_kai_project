...
1. 对线性规划
   ...
   使用单纯形法求解；写出其对偶问题；说明原问题与对偶问题的最优目标值相等；并分析第一条约束右端常数变化时的灵敏度。
2. 有一个从顶点 0 到顶点 2 的有向网络，弧 $0\to1$、$0\to2$、$1\to2$ 的容量分别为

   $$
   c_{01}=1,\qquad c_{02}=1,\qquad c_{12}=2.
   $$

   写出顶点 0 到顶点 2 的最大流问题及其对偶问题，并说明各对偶变量的含义。
3. 对 0–1 背包问题
   ...
   先求其线性松弛问题的最优解，再使用分支定界法求出原整数问题的最优解。
