...
1. 说明 minimax 方法，并且在说明中必须使用“局面的评价值”“评价值最高”“评价值最低”“有利”“不利”这五个概念。
2. 说明为什么 minimax 方法所选择的走法有时实际上并不是最佳走法。
3. 说明 alpha-beta 方法，并且在说明中必须使用“评价值最高的走法”“评价值最低的走法”“上界”“下界”“$\alpha$ 剪枝”“$\beta$ 剪枝”这些概念。

#### 考点

- **极小极大算法**：需要说明 MAX 与 MIN 节点如何分别回传最高和最低局面评价值，以及有限搜索深度、启发式评价误差等因素为何可能使所选走法偏离实际最优。
- **$\alpha$–$\beta$ 剪枝**：需要结合 $\alpha$ 下界、$\beta$ 上界及 MAX/MIN 节点的最佳已知走法，准确说明 $\alpha$ 剪枝和 $\beta$ 剪枝的触发条件与作用。
