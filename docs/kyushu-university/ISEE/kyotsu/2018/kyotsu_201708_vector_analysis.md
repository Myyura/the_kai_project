...
&= \int_0^{2\pi}\left(-\frac{3}{2} - \frac{1}{2}\cos2\theta\right)d\theta \\
...
\left(-\cos\theta\sin^2\theta\sin\phi
-3\cos\theta\sin\theta\right)d\theta\,d\phi\\
&=-6\pi\int_0^{\pi/2}\cos\theta\sin\theta\,d\theta\\
&=-3\pi.
\end{aligned}
$$
