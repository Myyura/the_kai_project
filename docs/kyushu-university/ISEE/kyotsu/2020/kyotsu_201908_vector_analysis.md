...
$$
z = x^2 + y^2 = \big(\frac{\sqrt{2}}{4}\big)^2 + \big(\frac{\sqrt{2}}{4}\big)^2 = \frac{1}{4}
$$
...
$$
\iint_S \mathbf{A} \cdot \mathbf{n}\,dS = \iiint_{V} \nabla \cdot \mathbf{A}\,dV = \int_0^{2\pi} \int_0^3 \int_0^4 2(r\cos\theta - r\sin\theta + z)r\,dz\,dr\,d\theta = 144\pi
$$
