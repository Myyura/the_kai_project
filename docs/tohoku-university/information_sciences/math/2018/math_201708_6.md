...
设 $n$ 为自然数，$X_1,\ldots,X_n$ 为 $[0,1]$ 上独立同分布的均匀随机变量，并令
$$
M_n=\max\{X_1,\ldots,X_n\},\qquad
L_n=\min\{X_1,\ldots,X_n\}.
$$

1. 对任意实数 $x$，求分布函数 $F(x)=P(M_2\le x)$。
2. 求 $M_2$ 的概率密度函数与期望。
3. 求 $L_n$ 的概率密度函数与期望。
...
- [東北大学 情報科学研究科 数学教室 2017年8月試験（PDF）](https://www.math.is.tohoku.ac.jp/admission/docs/1708.pdf)
