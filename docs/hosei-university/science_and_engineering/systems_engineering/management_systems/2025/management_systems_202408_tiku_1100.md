...
$$
A^c=[0,1/4],\qquad
B^c=(1/4,1/2]\cup\{0\},\qquad
C^c=(1/2,3/4]
$$

とすると、$A^c\cap B^c=\{0\}\ne\varnothing$ だが、その確率は $0$ である。各事象の確率は $3/4$、任意の二事象の共通部分の確率は $1/2\ne(3/4)^2$ なので、これらは独立ではない。それでも三事象の共通部分の確率は $1/4$、不等式の右辺も $1-3/4=1/4$ となり、狭義不等式は成り立たない。
