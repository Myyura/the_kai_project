...
<figure style="text-align:center;">
  <img src="https://raw.githubusercontent.com/Myyura/the_kai_project_assets/main/kakomonn/InstituteOfScienceTokyo/engineering/ee_202208_electromagnetism_1_p1.png" width="350" alt=""/>
</figure>
...
<figure style="text-align:center;">
  <img src="https://raw.githubusercontent.com/Myyura/the_kai_project_assets/main/kakomonn/InstituteOfScienceTokyo/engineering/ee_202208_electromagnetism_1_p2.png" width="350" alt=""/>
</figure>
...
<figure style="text-align:center;">
  <img src="https://raw.githubusercontent.com/Myyura/the_kai_project_assets/main/kakomonn/InstituteOfScienceTokyo/engineering/ee_202208_electromagnetism_1_p3.png" width="500" alt=""/>
</figure>
...
回答关于真空中固定平行板电容器的下列问题。真空介电常数为 $\varepsilon_0$，忽略边缘效应。

1. 如原 Description 图 1.1，把两块厚度可忽略、边长分别为 $a,b$ 的矩形导体板以间距 $x$ 平行放置。

   1. 用 $a,b,x,\varepsilon_0$ 表示电容 $C_1$。
   2. 在两板间施加电位差 $V$。用 $a,b,x,V,\varepsilon_0$ 中必要的量分别表示板间电场强度 $E_1$、静电能 $U_1$ 和两板间静电力大小 $F_1$；并说明静电力使两板相吸还是相斥。
   3. 如图 1.2，给两板分别加上 $\pm Q$，且电荷均匀分布。用 $a,b,x,Q,\varepsilon_0$ 中必要的量分别表示板间电场强度 $E_2$、静电能 $U_2$ 和静电力大小 $F_2$；并说明力为吸引还是排斥。

2. 两块厚度可忽略、边长为 $a$ 的正方形导体板以间距 $x$ 平行放置。如图 1.3，将一块边长 $a$、厚度 $d$、介电率 $\varepsilon>\varepsilon_0$ 的正方形不带电介质板置于两导体板之间的正中位置并与之平行，从一侧插入长度
