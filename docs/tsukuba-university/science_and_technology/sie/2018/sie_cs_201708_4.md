...
#### <center> 表 3: 関数 calc() が文字，文字列，および，整数を操作するために利用する関数</center>
|関数|説明|
|-|-|
...
```
#### <center> 図 2: 後置記法の数式を計算する関数 calc()</center>
...
```
#### <center> 図 3: 関数 calc() の利用例</center>
...
```
#### <center> 図 4: 関数 do sub() と do cond()</center>
