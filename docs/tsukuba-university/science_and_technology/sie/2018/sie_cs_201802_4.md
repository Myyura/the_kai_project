...
```
#### <center> 図 1: 整数のリストを保持する構造体 ilist の定義.</center>
...
#### <center> 表 1: 構造体 ilist を操作する関数.</center>
|関数|説明|
|-|-|
...
#### <center>图 1：保存整数列表的结构体 `ilist` 的定义</center>

<figure style="text-align:center;">
  <img src="https://raw.githubusercontent.com/Myyura/the_kai_project_assets/main/kakomonn/tsukuba_university/science_and_technology/sie_cs_201802_4_p1.png" width="600" height="263" alt=""/>
</figure>

#### <center>表 1：操作结构体 `ilist` 的函数</center>
...
### (8)
平衡二分探索木を用いれば、探索と挿入をともに $O(\log n)$ 時間で行え、配列のように後続する $O(n)$ 個の要素をずらす必要がない。
