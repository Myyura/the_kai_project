...
完成下列各问：
   ...
   1. 求 $\det\boldsymbol{A}$。
   2. 求 $\boldsymbol{A}^{-1}$。
   3. 求 $\boldsymbol{A}$ 的全部特征值以及各自对应的特征向量。
   4. 判断 $\boldsymbol{A}$ 是否为正定矩阵，并说明理由。
   5. 将 $\boldsymbol{A}$ 对角化。
...
$$
c\begin{pmatrix}2\\1\end{pmatrix},\qquad c\ne0
$$
...
$$
c\begin{pmatrix}1\\-2\end{pmatrix},\qquad c\ne0
$$
