---
sidebar_label: '2021年7月実施 専門基礎A [A-5]'
tags:
  - Kyoto-University
...
$$
A\mapsto0,\quad B\mapsto111,\quad C\mapsto100,\quad
D\mapsto110,\quad E\mapsto101.
$$

Merge weights $0.08+0.16=0.24$, $0.16+0.20=0.36$, $0.24+0.36=0.60$, and finally $0.40+0.60=1$.
...
3. Under the assumption of at most two errors, use a syndrome table to find the unique error pattern $e$ of weight at most two. If no such pattern has that syndrome, report an uncorrectable error. With more than two errors, correct decoding is not guaranteed.
