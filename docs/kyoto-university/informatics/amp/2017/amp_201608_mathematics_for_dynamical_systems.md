...
在 $t>0$ 上考虑 $n$ 元线性微分方程组

$$
\frac{d\boldsymbol x}{dt}=\frac1t A(t)\boldsymbol x,
...
- **线性常微分方程组的递推求解**：利用下双对角系数矩阵，将各分量方程按顺序递推积分。
- **任意维通解的归纳表达**：从 $n=1,2$ 的结构归纳一般 $n$ 时包含全部积分常数的显式解。
