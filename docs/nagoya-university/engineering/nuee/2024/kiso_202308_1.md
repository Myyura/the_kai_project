...
- (ii) $J_n = \int_0^{\pi} \left\{\frac{\sin nx}{\sin x}\right\}^2 dx$
...
$$
\begin{aligned}
  I_n - I_{n-2} &= \int_{0}^{\pi} \frac{\sin nx (1 - \cos 2x) + \sin 2x \cos nx}{\sin x}dx \\
...
$$
J_n = \int_0^{\pi} \left\{\frac{\sin nx}{\sin x}\right\}^2dx = \int_0^{\pi} \frac{1-\cos 2nx}{2\sin^2 x}dx
$$
