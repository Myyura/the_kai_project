...
1. 求复函数
   ...
   f(z)=\frac1{z^6+1}
   $$
   在上半平面 $\{z=x+iy\mid x,y\in\mathbb R,\ y>0\}$ 内的全部极点及其留数。
2. 使用留数定理求 $I$。
...
![積分領域または積分経路](https://raw.githubusercontent.com/Myyura/the_kai_project_assets/main/kakomonn/nagoya_university/mathematics/2021/nagoya-math2021-contour.svg)
