---
sidebar_label: '2018年7月実施 午前の部 [1]'
tags:
  - Nagoya-University
...
---
# 名古屋大学 多元数理科学研究科 2018年7月実施 午前の部 \[1\]
...
出典：[名古屋大学公表問題](https://www.math.nagoya-u.ac.jp/ja/admission/gs/download/exam-mc-2019-1_am.pdf)。
...
1. 证明 $\mathbb R^4$ 中向量
   $$
   (1,2,0,1)^\top,\quad(1,0,-2,-1)^\top,\quad(1,1,0,2)^\top
   $$
   线性无关。
2. 证明 $\mathbb R^4$ 中向量
   $$
   (1,1,1,1)^\top,\quad(2,3,1,2)^\top,\quad(2,1,-1,0)^\top
   $$
   线性无关。
3. 分别令 $V_1,V_2$ 为上述两组三向量张成的子空间，求 $\dim(V_1+V_2)$。
4. 求 $\dim(V_1\cap V_2)$ 及 $V_1\cap V_2$ 的一组基。
